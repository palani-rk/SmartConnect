import { UXTestSuite, UXTestScenario, ProjectInfo } from './types';
...
export class TestGenerator {
  ...
  private generatePageScenarios(
    ...
    const scenarios: UXTestScenario[] = [];
  ...
  private generateLoadingScenarios(pageName: string, pageUrl: string): UXTestScenario[] {
    return [
      {
  ...
  private generateInteractionScenarios(pageName: string, pageUrl: string): UXTestScenario[] {
    return [
      {
  ...
  private generateFormScenarios(pageName: string, pageUrl: string): UXTestScenario[] {
    const scenarios: UXTestScenario[] = [];
  ...
  private generateNavigationScenarios(pageName: string, pageUrl: string): UXTestScenario[] {
    return [
      {
  ...
  private generateResponsiveScenarios(pageName: string, pageUrl: string): UXTestScenario[] {
    return [
      {
  ...
  private isFormPage(pageName: string): boolean {
